...
const variantClasses: Record<Variant, string> = {
  primary:
    "bg-[var(--brand)] text-[var(--neutral-950)] border border-[var(--brand)] hover:bg-white hover:text-[var(--coral-700)] hover:border-[var(--coral-700)]",
  "ghost-light":
  ...
  "ghost-brand":
    "bg-transparent text-[var(--coral-700)] border border-[var(--coral-700)] hover:bg-[var(--brand)] hover:text-[var(--neutral-950)]",
  light:
    "bg-white text-[var(--neutral-950)] border border-white hover:bg-[var(--brand)] hover:text-[var(--neutral-950)] hover:border-[var(--brand)]",
};
