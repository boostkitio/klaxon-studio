...
export const workAll: Project[] = [
      ...
      { id: "fei-sports-feature", href: "/work/fei-sports-feature", client: "FEI / Sunset + Vine", sector: "Sport", title: "Sports feature", cat: ["Documentary", "Sport"], ar: "16 / 9", video: "https://stream.mux.com/3ibGzWgwDlJsEPeGMrTZhbx1tcdWjGpafZ4AIzEo8Uw/highest.mp4", vimeo: "988530705", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:11:02Z", duration: "PT7M27S",
        ...
        faqs: [
          { q: "Do you produce content for broadcast television?", a: "Yes. We have extensive experience producing content for broadcast, including series distributed to over 50 broadcasters globally. Broadcast production has specific technical and creative standards - resolution, frame rate, audio specifications and delivery formats - and we understand what's required at each stage of the process." },
          ...
          { q: "Can you travel internationally for shoots?", a: "Yes. We regularly shoot across Europe and beyond. International productions require careful logistical planning - kit carnets, travel, local permits, and on-the-ground preparation - and we handle all of it as part of the production process." },
