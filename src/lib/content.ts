...
export const workAll: Project[] = [
      { id: "boss-brand-promo", href: "/work/boss-brand-promo", client: "BOSS", sector: "Fashion", title: "Brand promo", cat: ["Branded", "Social"], ar: "3 / 4", video: "https://stream.mux.com/302UbMIkwPH502t3w6LTTS6XOzH02024rutfQioEwNxaBCU/highest.mp4", vimeo: "988531174", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:12:11Z", duration: "PT1M30S",
        ...
        faqs: [
          { q: "Do you handle creative development, or just execute someone else's brief?", a: "Both, and it depends entirely on what the client actually needs. Some clients arrive with a fully locked creative direction and want us to execute it precisely. Others give us a strategic goal and trust us to develop the shooting style, tone and structure ourselves. On the BOSS launch, that meant developing the teaser's tone independently once the overall brief was set." },
          { q: "What's involved in filming with a high-profile ambassador or public figure?", a: "Scheduling has to bend around their availability rather than a standard studio day, and interviews need structuring so a personal story comes through naturally rather than sounding rehearsed or media-trained. When family members or other public figures are involved, as with Harry Charles and his Olympic gold medallist father, balancing multiple voices in the edit without losing focus becomes its own challenge." },
          { q: "Why would a brand launch with a teaser and a separate main film, rather than one piece?", a: "A teaser and a main film serve different jobs, one creates intrigue by deliberately withholding information, the other delivers the actual payoff and narrative. Treating them as genuinely separate creative briefs, rather than one film cut two ways, is usually what makes a staged launch campaign land properly." },
        ] },
      { id: "goodwood", href: "/work/goodwood", client: "Goodwood Festival of Speed", sector: "Automotive", title: "Lifestyle film", cat: ["Automotive"], ar: "16 / 9", video: "https://stream.mux.com/874Mk3rOWrK024Mpg6x5xnK43Ojuv02r9YzVIZmCID7BU/highest.mp4", vimeo: "988530867", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:11:28Z", duration: "PT6M25S",
        ...
        body: [
          "A lot of fun was had on this lifestyle film for the Goodwood organisation to show at the iconic Festival of Speed! Shot entirely on location in the Italian hills outside of Bologna, featuring a beautiful Lamborghini driving on some of the most photogenic roads in Europe - what more could you want?!",
          "Shooting in intense summer heat pushed both crew and kit to their limits. The crew needed regular breaks and a substantial amount of suncream! The in-car cameras struggled with overheating in the scorching sunlight, which was a genuine production problem when time with the vehicle was limited. The solution was to shoot the in-car sequences in sections, giving the cameras time to recover between setups (the divas!). It added a layer of complexity to the schedule, but it's the kind of problem that with our experience and preparation makes totally manageable.",
          "This was one of those shoots where whichever way you pointed the camera you had a beautiful shot. With a Lamborghini in the hills of Bologna we really were spoiled for choice, it was hard to choose which ones to leave out of the final edit!",
        ],
        faqs: [
          { q: "Do you produce automotive video content?", a: "Yes automotive production is a significant part of what we do. We've shot for brands including Lamborghini, Aston Martin, BMW and McLaren across a range of formats, from studio shoots and product films to lifestyle and documentary content. Whatever the brief, the approach is the same - the vehicle has to look its absolute best, and everything else is built around that." },
          { q: "Do you have experience filming with high-value vehicles?", a: "Yes. Working with high-value vehicles supercars, classic cars, prototype machinery requires a level of care and professionalism that goes beyond standard production. Access is often tightly controlled, time with the vehicle is limited, and everyone on set understands what they're working with. We treat every vehicle accordingly." },
          { q: "How do you handle extreme weather conditions on location shoots?", a: "Shooting in intense heat, cold, or unpredictable conditions requires preparation. Crew welfare, kit management, and contingency planning all need to be factored in. High temperatures in particular can cause cameras to overheat, which affects scheduling and requires careful management on the day. Between us we've shot in 23 countries across every kind of condition imaginable." },
        ] },
      { id: "historic-england-bruce-grove", href: "/work/historic-england-bruce-grove", client: "Historic England", sector: "Heritage", title: "Bruce Grove short doc", cat: ["Documentary", "Social"], ar: "1 / 1", video: "", vimeo: "1208377115", vimeoHash: "7ce7cef536", vimeoAr: "16 / 9", uploadDate: "2026-07-09T06:34:34Z", duration: "PT9M1S", vimeoThumb: "https://i.vimeocdn.com/video/2177689621-20527acb4b141c6876f720174263c98844370251daa810d21ba0f8b3730ac8c1-d_960x540?region=us",
        ...
        body: [
          "In late 2025, Klaxon won a public sector tender to become an approved video supplier for Historic England. We direct, shoot, and edit films for them in-house. Our first commission was a short documentary about Bruce Grove Toilets in Tottenham. Yes, a toilet block. Bear with us!",
          "Built in the Victorian era, the Bruce Grove Toilets hold a genuinely significant place in history - they were among the first public toilets purpose-built for female use, making them an important landmark in the story of women's rights. By the 1980s they had fallen into disrepair and were eventually closed. A grant from Historic England and local bodies funded their restoration, and the toilet block recently reopened as a community cafe.",
          "Our brief was to tell the story of the Toilet block to the present day and tell the significance it holds in cultural history. Matt directed it, Charlie and Jake shot it, and the edit was handled in-house at Klaxon. Matt and Charlie also led the creative development.",
          "The approach was to avoid anything overly formal and instead give the film a light touch, using humour but also being respectful to the significance of the subject matter. Heritage filmmaking often requires a particular sensitivity and getting the tone right is vital. We wanted the film to be authoritative without being dry, yet be engaging without being flippant. The Bruce Grove film is a great example of what that looks like in practice.",
        ],
        faqs: [
          { q: "Do you work with public sector organisations?", a: "Yes, we are an approved supplier for Historic England, having won a competitive public sector tender in 2025. We understand the specific requirements that come with public sector commissions such as procurement processes, sign-off structures, and the expectation that public money is being spent wisely." },
          { q: "Do you produce heritage and documentary films?", a: "Yes, heritage filmmaking is a discipline that rewards genuine curiosity and careful creative development and it also helps that part of the team at Klaxon have a genuine interest in HIstory! The best heritage films find the human story inside the historical one and that requires a production team willing to do the research and ask the right questions - which is all very easy when you\u2019re genuinely interested in the subject." },
          { q: "Can you handle the full production process in-house?", a: "Yes, Klaxon is fully \u2018end to end\u2019. We handle creative development, production management, directing, shooting, and editing entirely in-house. There are no handoffs to third-party editors or post-production houses, the same team that develops the creative sees it through to the final cut." },
        ] },
      { id: "commonwealth-games", href: "/work/commonwealth-games", client: "Commonwealth Games", sector: "Sport", title: "Sports profile VT", cat: ["Sport"], ar: "16 / 9", video: "https://stream.mux.com/GNhcNZhucIklk5w00cHgLHnP1YjsqlQ6FVYYhqAwsjcI/highest.mp4", vimeo: "988534829", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:22:00Z", duration: "PT3M0S",
        ...
        body: [
          "A sports profile VT on Louise Sugden, Paralympic powerlifter and Commonwealth Games competitor, commissioned by Sunset+Vine for broadcast use across the Commonwealth Games and its global network of broadcasters.",
          "To keep this production lean, Charlie handled the entire production solo - producing, directing, shooting, and editing the piece from start to finish.",
          "The gym near Maidenhead was small and the exterior unusable, which meant working creatively within the space available. Kit was kept deliberately lightweight using two cameras paired with zoom lenses and a 300D - a run-and-gun setup that kept things nimble without sacrificing quality. The approach was to shoot quickly and fluidly around the space, then bring a more considered, premium feel to the interview, giving the finished piece the feel of a proper broadcast feature rather than a quick-turnaround news package.",
          "Louise was a natural, open, generous with her time, and completely at ease in front of the camera. When the talent is that good, it makes our job very much easier!",
          "The finished VT was picked up by a number of broadcasters for use on their own channels, and played across digital platforms and the main screens at the event itself. A one-man operation that punched well above its weight.",
        ],
        faqs: [
          { q: "Can you produce self-shooting, single-operator productions?", a: "Yes, when the brief calls for it. There are projects where a single experienced operator - producing, directing, shooting, and editing, is the right solution, whether that's driven by access, budget, or turnaround. Our team are capable of working that way without compromising the output. That said, most of what we do involves a full crew, and we'd always recommend the right setup for the job rather than defaulting to the lightest option." },
          { q: "Do you produce sports and athlete profile VTs?", a: "Yes. Athlete profiles require a specific approach - getting a subject who may not be a natural presenter to open up on camera, often in an environment that isn't particularly conducive to filming. The best sports profile VTs feel like proper broadcast features rather than quick-turnaround packages. That's a creative and technical challenge, and one we've executed well time and time again." },
          { q: "Can you turn around broadcast-quality content quickly?", a: "Yes. Fast turnarounds are a reality of broadcast and live event production. The key is preparation - knowing exactly what you need before you walk through the door, and having the experience to adapt when things don't go to plan." },
        ] },
      { id: "jack-stein-inside-the-box", href: "/work/jack-stein-inside-the-box", client: "Jack Stein: Inside the Box", sector: "Food", title: "Food docu-series", cat: ["Documentary"], ar: "1 / 1", video: "https://stream.mux.com/ekAatUZ1Ne3c9EYRNyEVyED9mZLHgQ4HgpidWhC2BAQ/highest.mp4", vimeo: "988531291", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:12:32Z", duration: "PT1M0S",
        ...
        body: [
          "A Food Network UK series following chef Jack Stein as he travelled the world taking classic British dishes to different cultures, with varying degrees of success. Ten cities, six months, and some genuinely interesting reactions to British cuisine!",
          "The format took Jack across the globe, pairing him with a local chef in each city to put a twist on whichever British dish he'd brought with him. Despite all the globetrotting, the filming kicked off with a week in a beautiful Cornwall cottage, filming the cooking segments for every episode, each dish prepared and shot there before Jack took it around the world.",
          "This production was handled through our good friends \u2018The Projucers\u2019 down in Australia who requested our help in the filming of the series. It's the kind of production that Jake is well suited to - long-form, international, fast-moving, and involving lots of food.",
        ],
        faqs: [
          { q: "Do you have experience in food and lifestyle documentary production?", a: "Yes, and a significant amount of it. Between the team, we have extensive experience directing, shooting, and editing food content, from broadcast documentary series to lifestyle and branded content. Food production is a specific discipline; the lighting, the pacing, the way you shoot a dish or a kitchen environment requires a particular eye and a lot of practice to get right. We've been doing it for years, across the UK and internationally." },
          { q: "Do you supply crew to third-party productions?", a: "Yes, we regularly supply crews and camera operators to other production companies. Whether that's a full crew package for a multi-day shoot or a single operator when the brief calls for it. If you're a production company looking for experienced, broadcast-credited crew, get in touch." },
          { q: "Do you provide UK production services for international productions?", a: "Yes, we regularly work with international production companies who need reliable support on the ground in the UK. That goes beyond supplying crew and kit, we know the locations, we understand the permit landscape, and we have the local knowledge to make a UK shoot run smoothly. Whether it's a single shoot day or an extended series, we can handle as much or as little of the logistics as you need." },
          { q: "Can you support long-form series production?", a: "Yes, series production requires consistency across multiple episodes, often shot across different locations and over an extended period. We're experienced working within that format and maintaining a coherent visual style and standard of quality right through production." },
        ] },
      { id: "fei-sports-feature", href: "/work/fei-sports-feature", client: "FEI / Sunset + Vine", sector: "Sport", title: "Sports feature", cat: ["Documentary", "Sport"], ar: "16 / 9", video: "https://stream.mux.com/3ibGzWgwDlJsEPeGMrTZhbx1tcdWjGpafZ4AIzEo8Uw/highest.mp4", vimeo: "988530705", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:11:02Z", duration: "PT7M27S",
        ...
        body: [
          "The FEI is the governing body of world equestrian sport. Sunset+Vine commission a series of sports features on their behalf  - ten 30-minute programmes per year, distributed to over 50 broadcasters globally and reaching upwards of 400 million households. Klaxon are the production team behind the features that make up those programmes.",
          "Known as ‘The Ride’, the series has evolved over the years into something closer to a lifestyle and culture programme than a typical sports show - beautifully shot films that explore the equestrian world in all its forms, from the competitive to the human.",
          "Each feature runs six to eight minutes and sits within the broader 30-minute broadcast format. The subjects vary, but the brief is consistent - find the story, shoot it beautifully, and make it work for a global broadcast audience.",
          "Charlie and Jake have taken these films all across Europe, operating as self-shooting producer-directors. It's a demanding format that requires someone who can work quickly and independently in unfamiliar locations while still producing content that hits the high broadcast standard.",
        ],
        faqs: [
          { q: "Do you produce content for broadcast television?", a: "Yes. We have extensive experience producing content for broadcast, including series distributed to over 50 broadcasters globally. Broadcast production has specific technical and creative standards such as resolution, frame rate, audio specifications, delivery formats and we understand what's required at each stage of the process." },
          { q: "What does a self-shooting producer-director actually do?", a: "A self-shooting producer-director handles the entire production process solo, this includes planning, logistics, directing, operating the camera, and often editing the finished piece. It's the most efficient format for certain briefs, particularly where access is tight, turnaround is fast, or budget doesn't stretch to a full crew." },
          { q: "Can you travel internationally for shoots?", a: "Yes. We regularly shoot across Europe and beyond. International productions require careful logistical planning such as kit carnets, travel, local permits, and on-the-ground preparation and we handle all of it as part of the production process." },
          { q: "Do you work on ongoing series and retained briefs?", a: "Yes. Some of our longest-running work involves series production, returning to the same brief multiple times a year with consistent quality across every episode. If you're commissioning a series rather than a one-off project, we're well set up to deliver it" },
        ] },
      { id: "peugeot-multi-camera", href: "/work/peugeot-multi-camera", client: "Peugeot", sector: "Automotive", title: "Multi-camera tennis challenge", cat: ["Branded", "Sport"], ar: "16 / 9", video: "https://stream.mux.com/Cbn4PS6Km4ejUNw6o02y01WHUDMEstYiV00g00tuIAPL3B00/highest.mp4", vimeo: "1003234232", vimeoHash: "bf316591c9", vimeoAr: "16 / 9", uploadDate: "2024-08-27T10:58:48Z", duration: "PT2M30S",
        ...
        faqs: [
          { q: "How do you prepare for filming a live event you can't control?", a: "Live events only give you one pass, so unlike a scripted shoot, planning has to happen entirely before the day. That means camera positions, lens choices and a clear division of coverage between crew members all need to be locked down in advance, since there's no ability to stop, reset or reshoot once things are underway." },
          { q: "What's the value of multi-camera coverage for event or sponsorship content?", a: "It captures genuine, unscripted reactions from multiple angles simultaneously, which matters when the whole appeal of the content is that it feels real rather than staged. For sponsorship activations specifically, that authenticity is often the entire reason a brand wants to be associated with the event in the first place." },
          { q: "Why sponsor entertainment content instead of making a straightforward product film?", a: "Association with a genuinely enjoyable event does something a studio ad can't, it puts a brand inside a cultural moment audiences already want to engage with, rather than asking them to watch an advert. The content works because it reads as coverage first and branded messaging second." },
        ] },
      { id: "travis-mathew-ambassador-documentary", href: "/work/travis-mathew-ambassador-documentary", client: "Travis Mathew", sector: "Apparel", title: "Ambassador documentary", cat: ["Branded", "Sport"], ar: "16 / 9", video: "", vimeo: "1208364200", vimeoHash: "a0715c635d", vimeoAr: "16 / 9", uploadDate: "2026-07-09T05:41:52Z", duration: "PT10M26S", vimeoThumb: "https://i.vimeocdn.com/video/2177670842-5bb64a967838efe355b96b44f1a689d80e51087787ee0a66f79e322a7dc65da6-d_960x540?region=us",
        ...
        body: [
          "This project was a four-part documentary series following Josh Berry, a young British golfer who had just earned his place on the DP World Tour at a remarkably early age. It was commissioned by his sponsor Travis Mathew.",
          "Matt and Charlie led the production across two separate shoot phases. The first was a day in Doncaster, capturing interviews with Josh and the people around him at the moment he made it on to the tour, featuring interviews with family, coaches and the people who'd watched him get there. The second came later in the year, once the tour season had played out, to capture the narrative of what had actually happened. This time that was a mix of interviews and specially constructed sequences to illustrate what the interviews described.",
          "That second element was where the creative problem-solving came in. Without rights to broadcast tour footage, there was no archive to cut to when Josh talked about life on tour or his journey to get there. The solution was to build it from scratch, shooting b-roll sequences designed specifically to carry those moments, and digging through social archives and personal collections for photographs that could drive the edit.",
          "A documentary series like this lives or dies on the quality of the interviews. Getting a young athlete, someone not used to being in front of a camera for extended periods and getting them to open up honestly about a year that was by turns exciting, challenging, and at times brutal, requires a particular approach. The interview environment, the questions, the pacing of the day all of it shapes the end result. What Josh gave us was genuine, and that's what makes the series work.",
        ],
        faqs: [
          { q: "Can you produce multi-episode documentary series?", a: "Yes. Series documentary production requires a different discipline to a single film. There has to be a consistency of tone and visual style across episodes, a narrative arc that holds across the full run, and a production pipeline that can manage the volume of material involved. We plan that structure before we shoot, so the edit has a clear shape to work to from the outset." },
          { q: "How do you handle productions where archive footage isn't available?", a: "It can be a common challenge, particularly in sports documentary where broadcast rights are tightly controlled and very expensive to obtain. The answer is creative problem-solving, shooting b-roll sequences specifically designed to carry the moments that have no visual coverage, sourcing personal photography and social archives, and building sequences in the edit that illustrate what's being described rather than simply cutting away to existing footage. It takes more planning and more imagination, but the results are often stronger for it." },
          { q: "Do you produce ambassador and influencer content for brands?", a: "Yes. Brand ambassador content works best when it feels authentic, when the subject's story and the brand's values genuinely connect, rather than one being bolted onto the other. We work with brands to find that connection at the briefing stage, and build the production around it. The result is content that works for the brand without feeling like an advert." },
        ] },
      { id: "bmw-creative-car-review", href: "/work/bmw-creative-car-review", client: "BMW", sector: "Automotive", title: "Creative car reviews", cat: ["Branded", "Automotive"], ar: "16 / 9", video: "https://stream.mux.com/Fw028ShcEJsNWI7EyzPHlan6Meryw401ZaTLYl0100RyNME/highest.mp4", vimeo: "312000081", vimeoAr: "16 / 9", uploadDate: "2019-01-17T18:11:58Z", duration: "PT2M18S",
        ...
        faqs: [
          { q: "Why use a presenter rather than a voiceover-only format?", a: "A host gives content a point of view and personality that specs-and-voiceover formats can't replicate, which matters for premium or lifestyle-positioned brands where the product needs to feel aspirational rather than purely functional. For BMW, that meant choosing a host whose own profile matched the brand's positioning." },
          { q: "How do you plan a shoot spanning multiple locations and lighting conditions?", a: "Different environments, night streets, a race circuit, a controlled studio, each demand entirely different lighting rigs, crew calls and even lens choices. Scheduling also has to account for real-world constraints like traffic and location access, which rarely cooperate with a shoot plan, particularly for night shoots in a city that doesn't stop." },
          { q: "What separates premium branded car content from a standard manufacturer review?", a: "Most manufacturer reviews follow a template, walkaround, specs, driving shots. Pushing beyond that usually means investing in a recognisable host, genuine locations over generic backdrops, and cinematic lighting choices, so the content reads as editorial or media content rather than manufacturer marketing." },
        ] },
      { id: "aston-martin", href: "/work/aston-martin", client: "Aston Martin", sector: "Automotive", title: "V12 Vantage launch", cat: ["Automotive"], ar: "3 / 4", video: "https://stream.mux.com/35R023901blr00LZ01OxgY00emQunUd12MgaeUDOCfKkoBdE/highest.mp4", vimeo: "988536270", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:25:52Z", duration: "PT5M8S",
        ...
        faqs: [
          { q: "How do you choose camera and lens packages when budget is limited?", a: "It's a balance between the visual outcome the client needs and what's actually achievable financially. That often means mixing gear, a more affordable camera or lens for technical shots that need a specific capability, and a premium option reserved for shots where image quality is non-negotiable." },
          { q: "What's a contra-zoom, and when is it worth using?", a: "It's a technique where the camera moves toward the subject while the lens zooms out, creating a disorienting, dramatic pull that draws the eye to the subject. It works particularly well for hero product moments, like a car launch, where you want a single shot to carry real visual weight." },
          { q: "How much creative input do production companies typically get on agency-led work?", a: "It varies considerably by client and agency. Some agencies want pure execution of a locked concept. Others, once the core brief is set, actively want additional creative suggestions, which is what happened here when we proposed lens prisms to create foreground reflections that made it into the final cut." },
        ] },
      { id: "salesforce", href: "/work/salesforce", client: "Salesforce / Smyle Creative", sector: "Technology", title: "Customer testimonial", cat: ["Corporate"], ar: "16 / 9", video: "https://stream.mux.com/kgbHPetOQ2LQoJLDRXAHSn31iA4012Vr91dPbulaELTs/highest.mp4", vimeo: "988531570", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:13:15Z", duration: "PT2M35S",
        ...
        body: [
          "A customer testimonial film for Salesforce, commissioned through Smyle Creative and shot on location in the Netherlands. What better way to pitch to prospective clients than to hear from previous happy customers?!",
          "Jake and Charlie travelled out as crew for what was, on the surface, a straightforward testimonial brief but one that came with a larger crew and a more complex equipment setup than a typical talking head production.",
          "The shoot was carried out on Arri Amira and Alexa Mini cameras, paired with Arri Master Prime lenses, a high-end camera package and one of our favourites to use.",
          "Testimonial films live or die on the credibility of the subject - a genuine customer speaking honestly about their experience with a product is one of the most persuasive pieces of content a brand can have, more so than any amount of polished marketing copy.",
        ],
        faqs: [
          { q: "Do you produce customer testimonial videos?", a: "Yes, customer testimonial videos are a powerful tool in a brand's communications arsenal. A genuine customer speaking honestly about their experience carries more weight than any amount of polished marketing copy. The key is getting the right subject, asking the right questions, and creating an environment where they can speak naturally and credibly. We've produced testimonial content for some of the world's leading technology and professional services brands." },
          { q: "Do you work as crew for creative agencies?", a: "Yes, we regularly work with creative and event agencies as a production crew, bringing our own kit, expertise, and experience to productions that are being managed and creative-directed elsewhere. If you're an agency that needs a reliable, experienced crew for a shoot, we're well placed to help." },
          { q: "Do you shoot internationally?", a: "Yes, we travel regularly for productions across Europe and beyond. International shoots require careful logistical planning, kit carnets, travel, local permits, and on-the-ground preparation and we handle all of it as part of the production process." },
          { q: "Do you work with high-end cinema camera packages?", a: "Yes, while our owned kit centres on the Sony cinema line, we work across a range of camera systems depending on what the brief demands, including Arri Amira and Alexa Mini with Master Prime lenses when the production calls for it. The camera package is always chosen to serve the brief, not the other way around." },
        ] },
      { id: "shell", href: "/work/shell", client: "Shell / The Telegraph", sector: "Energy", title: "Branded content", cat: ["Branded", "Automotive"], ar: "16 / 9", video: "https://stream.mux.com/Om2sTVFts00HTqCvRPFyfcwtXVyS8YGWnBBYWVYrC5Zk/highest.mp4", vimeo: "988531350", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:12:40Z", duration: "PT1M38S",
        ...
        body: [
          "The Trident Iceni is a handmade British sports car produced in small numbers from a workshop in Norfolk - one of those gloriously niche automotive stories that most people have never heard of. A diesel-powered grand tourer built entirely by hand in the English countryside, by a small team with an extraordinary attention to detail.",
          "The project was commissioned by The Telegraph as part of a series of branded content films for Shell. Charlie spent two days at the Trident workshop in Norfolk, shooting the general workings of the place, the build process, the craftsmanship, the people behind it, and the character of a small workshop where something genuinely remarkable was being made.",
          "The edit was handled by The Telegraph Media Group. It's a film we remain proud of and a good example of what branded content can achieve when the subject matter is allowed to lead. The brief was Shell's but the story belonged to the people in that Norfolk workshop.",
        ],
        faqs: [
          { q: "Do you work with media groups and publishers on branded content productions?", a: "Yes. We have a long-standing relationship with Telegraph Media Group and have produced content commissioned through them on behalf of major brands as well as the Guardian Group. Working within a publisher context means the editorial standards are high and the content needs to hold its own alongside the publication's own output, a standard we're well used to working to." },
          { q: "Do you produce documentary-style branded content?", a: "Yes, documentary-style branded content is one of our specialisms. The approach of finding a genuine story, letting it lead, and trusting the audience to make the connection with the brand, consistently produces more effective content than a conventional promotional film. It requires editorial confidence and a production team that understands the difference between storytelling and a sales pitch." },
          { q: "Do you shoot in unusual or niche locations?", a: "Yes, absolutely! Some of the best branded content comes from the most unlikely places - a handmade sports car being built in a Norfolk workshop, for instance. Finding the story in an unexpected location is part of the job, and we're as comfortable in a small workshop as we are in a corporate headquarters." },
        ] },
      { id: "nested", href: "/work/nested", client: "Nested", sector: "Property", title: "Social media campaign", cat: ["Corporate"], ar: "3 / 4", video: "https://stream.mux.com/YxwZU01pBBOcZkT4qzsXoDiK7jJGwmmIpoUyvN7DdhWs/highest.mp4", vimeo: "988532031", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:14:28Z", duration: "PT50S",
        ...
        faqs: [
          { q: "How do you keep a large multi-location shoot efficient?", a: "Minimising kit is usually the answer, handheld cameras and prime lenses let a crew move quickly between locations without heavy lighting setups slowing things down, reserving proper lighting only for moments that genuinely need it. That approach scales well whether you're covering two locations or, as with Nested, six boroughs in six days." },
          { q: "Why have talent speak directly to camera rather than using narration?", a: "Direct address builds trust faster, particularly for service-based brands where the viewer might realistically end up dealing with that exact person. Pairing that with a natural, unstaged setting reinforces the same sense of authenticity rather than undermining it with an overly polished environment." },
          { q: "How closely should a production company work with a client's in-house marketing team?", a: "As closely as the project allows. Developing the creative approach jointly, rather than presenting a finished concept for approval, usually produces content that sounds and feels authentic to how the brand's own people actually communicate, rather than how an outside production company assumes they should." },
        ] },
      { id: "scott-brash", href: "/work/scott-brash", client: "Scott Brash", sector: "Sport", title: "Training app videos", cat: ["Sport"], ar: "16 / 9", video: "https://stream.mux.com/1nrQjJ2c8hNnAhpX01UJIL3s023eDOQMT1ENqcSLCMVvA/highest.mp4", vimeo: "988531826", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:13:52Z", duration: "PT3M4S",
        ...
        body: [
          "Scott Brash is one of the most decorated show jumpers in the world. The only rider ever to hold all five major Grand Prix titles simultaneously, his record in the sport is virtually unmatched. When he decided to launch an equestrian training app, he brought us in to handle the production.",
          "The brief was seventy instructional videos, a library of content covering every aspect of Scott's training methodology, filmed at his yard and delivered within a tight timeframe. We were shooting four to five videos per day across three weeks with a four-camera setup. Each instructional piece ran to around an hour of raw recording, which meant the data management alone was a significant undertaking.",
          "With three weeks of footage from four cameras to produce seventy deliverables, the post-production pipeline has to be planned as carefully as the shoot itself. The entire project, from first shoot day to final sign-off, was delivered within six weeks.",
          "Thankfully the weather held throughout, which on an outdoor equestrian shoot over three weeks in the UK is not something to take for granted. The horses had other ideas on occasion, but that's the nature of working with animals.",
          "The result is a comprehensive, professional content library that sits at the heart of Scott's training platform.",
        ],
        faqs: [
          { q: "Can you handle large volume content production?", a: "Yes. Large volume projects require a production pipeline that's as carefully planned as any individual shoot. Scheduling, data management, consistency of look across every piece of content, and a post-production workflow that can handle the throughput, all needs to be in place before the camera rolls. We've delivered projects running to dozens of individual pieces and know what's involved in making them run smoothly." },
          { q: "Do you have experience working with high-profile talent?", a: "Yes, and we do so regularly. We\u2019ve worked with globally recognised athletes, presenters, and c-suite executives across a range of sectors. We understand that world, and we know how to operate within it. Time is invariably the biggest constraint as high-profile people have limited availability, so making the most of every minute on set is something we plan for long before the shoot day arrives." },
          { q: "Do you produce training and instructional video content?", a: "Yes, training and instructional content is a specific discipline as the priority is clarity, consistency, and making sure the subject matter is communicated in a way that's genuinely understandable to the viewer." },
          { q: "Do you shoot with multiple cameras?", a: "Yes. When the content lends itself to it, a multi-camera setup is the most efficient way to capture a significant volume of material, particularly for instructional or interview-led work where coverage and consistency matter. We plan the camera setup around the brief and manage the additional data and post-production complexity that comes with it." },
        ] },
      { id: "rize", href: "/work/rize", client: "Rize", sector: "Consumer", title: "Stock-footage edit", cat: ["Corporate", "Social"], ar: "16 / 9", video: "https://stream.mux.com/NbNjw1chFxLn00YPjnR7QOlEgPq8yhRoMHbJswfONINw/highest.mp4", vimeo: "988531633", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:13:24Z", duration: "PT1M48S",
        ...
        body: [
          "Not every brief involves filming. For Rize ETF's climate change investment fund, the entire film was built from stock footage - no shoot day, no location, no original material. Just four days of deep asset sourcing, a professional voiceover artist, and six days in the edit.",
          "This film is a perfect example for creative storytelling in the digital realm, proving that engaging content doesn\u2019t require tangible product footage. However, the challenge with a brief like this is making it feel like a film rather than a montage of clips.",
          "Climate change as a subject has no shortage of powerful imagery available, the key is in sourcing the correct footage, the sequencing and implementing good sound design to tie it all together.",
          "The voiceover was recorded with a professional voice artist, with the sound design built carefully around them, using music and layering effects to create an atmospheric film that feels immersive whilst still being informative.",
          "The result is a film that communicates the scale of the problem and the case for investment action without using a single frame of original footage. It's a production approach that works particularly well for clients whose subject matter is complex, abstract, or doesn't lend itself to conventional filming. The constraint of working entirely in post can sometimes turn out to be a creative opportunity as much as a practical one.",
        ],
        faqs: [
          { q: "Can you produce a film without shooting any footage?", a: "Yes, not every brief requires original footage. For clients whose subject matter is abstract, data-led, or simply doesn't lend itself to conventional filming, a stock footage edit can be just as effective. The editorial skill is the same in finding the right material, shaping it into a coherent narrative, and building the sound design that brings it all together." },
          { q: "Do you offer post-production only services?", a: "Yes, post-production is one of our core disciplines. If you have existing footage that needs editing or a project that requires a grade, sound mix, motion graphics, versioning, or subtitling, we can handle that entirely in-house." },
          { q: "Can you source and direct voiceover artists?", a: "Yes, we source, cast, and direct voiceover artists as part of our production process. Script quality and casting matter more than most clients expect - the wrong voice, or a poorly directed recording session, undermines everything else." },
          { q: "Do you produce video content for financial services and investment brands?", a: "Yes, and it's one of our busiest sectors. We have extensive experience producing video for financial services clients across a range of formats, from investment fund communications, thought leadership content, internal comms and more. The subject matter is often complex and usually involves a lot of compliance requirements, both of which we're extremely well versed in navigating." },
        ] },
      { id: "badminton-horse-trials", href: "/work/badminton-horse-trials", client: "Badminton Horse Trials", sector: "Sport", title: "Anniversary promo", cat: ["Sport"], ar: "16 / 9", video: "", vimeo: "1208364202", vimeoHash: "f2b6cd4a85", vimeoAr: "16 / 9", uploadDate: "2026-07-09T05:41:52Z", duration: "PT1M43S", vimeoThumb: "https://i.vimeocdn.com/video/2177670527-4b00ee8b7972f902df36ec0de403d5de0fadd465e8bfd3e73398e19331eacbe4-d_960x540?region=us",
        ...
        body: [
          "Badminton Horse Trials is one of the great fixtures in world equestrian sport. First held in 1949, it has grown into one of the most prestigious three-day eventing competitions in the world, attracting the sport's elite riders. Attended by hundreds of thousands of spectators it sits alongside Burghley and Luhmuhlen at the very top of the sport's calendar. Marking its 75th anniversary was an occasion that warranted something genuinely cinematic.",
          "Klaxon were hired to shoot the anniversary VT - a pre-event film that would play on the big screens around the event site as well as across digital channels. The brief was a Netflix-style documentary look, referencing The Last Dance - atmospheric, interview-led with high production values.",
          "All interviews were shot in a single day at Badminton House itself and shooting in a space like that comes with its own set of challenges. The scale of the rooms created significant acoustic problems; sound blankets were rigged to deaden the echo and give the audio the expected clarity. The large windows meant light levels shifted constantly throughout the day as the clouds moved in and out, requiring continuous adjustment to keep the look consistent.",
          "The film was shot on our Sony FX9 cinema line cameras with Sigma Prime lenses, a combination chosen specifically for the depth and character it brings to interview work. The end result reflects the efficiency of the production - a single shoot day, a small crew, and the right kit choices to deliver a result that holds its own against productions with significantly larger budgets.",
        ],
        faqs: [
          { q: "What is equestrian video production?", a: "Filming horses, riders, and events at a professional level requires a specific set of skills - fast-moving subjects, unpredictable outdoor conditions, and environments that demand both technical precision and discretion. Show and competition horses are highly strung animals, and working around them requires a crew that knows how to move quietly, set up efficiently, and not spook a horse that's probably worth considerably more than the production budget!" },
          { q: "What equipment do you use for event and sports video production?", a: "Kit is always specified to the brief. For interview work, such as the Badminton project, we shot on Sony FX9 cinema line cameras with Sigma Prime lenses, chosen for their low f-stop and the cinematic quality they bring to that style of filming. For live sport, where flexibility and speed matter, we'd typically move to a lighter camera set-up such as the Sony FX6 paired with a high-end zoom lens like the Canon CN-E range, giving us the reach and flexibility needed for live sports." },
          { q: "Can you produce VTs for large-scale events?", a: "Yes. Content destined for large outdoor screens has specific technical requirements such as resolution, aspect ratio, and overall visual impact. All of that needs to be considered at the production stage rather than in post, we factor this in from the outset." },
          { q: "Do you work with production companies as a supplier?", a: "Yes, we regularly supply crews and kit to other production companies and agencies. Whether that's a DP and camera package, a full crew for a multi-day shoot, or anything in between. We're happy to work on a white label basis or as a named production partner, depending on what the project requires." },
        ] },
      { id: "mahou-beer-promos", href: "/work/mahou-beer-promos", client: "Mahou", sector: "Drinks", title: "Beer promos", cat: ["Branded"], ar: "16 / 9", video: "https://stream.mux.com/qlCs1JxItVxZ8Q9QB6sLp6a6auDOnvzY02fFV1hYWg8w/highest.mp4", vimeo: "325920534", vimeoHash: "c7917b056b", vimeoAr: "16 / 9", uploadDate: "2019-03-22T13:30:25Z", duration: "PT2M27S",
        ...
        faqs: [
          { q: "How do you introduce a brand into a market it hasn't launched in yet?", a: "The content usually has to do two jobs at once, build product awareness while also establishing a cultural or emotional association the audience doesn't already have. That often means weighting the storytelling toward atmosphere and lifestyle as much as the product itself, which is exactly what carried Mahou's Madrid tapas culture into a UK audience unfamiliar with the brand." },
          { q: "What's the challenge of working within a very short format like two minutes?", a: "Short formats force hard editorial decisions early, since there's no room to include every message a client might want. Treating each film as a self-contained story with its own beginning and end, rather than a compressed version of a longer film, tends to produce a stronger result." },
          { q: "How do you collaborate with a client's existing commercial or media team?", a: "Genuine collaboration from the concept stage, rather than being handed a finished brief, tends to keep tone and execution more consistent, especially across multi-location shoots where a shared understanding of the goal matters more than a rigid script." },
        ] },
      { id: "yorkshire-tea-branded-content", href: "/work/yorkshire-tea-branded-content", client: "Yorkshire Tea", sector: "Food", title: "Branded content", cat: ["Branded"], ar: "16 / 9", video: "https://stream.mux.com/53XIXwNcaqPIE6mYoVsaWeyVxh1SObZetWgS019H8Lgc/highest.mp4", vimeo: "312003484", vimeoAr: "16 / 9", uploadDate: "2019-01-17T18:37:40Z", duration: "PT2M34S",
        ...
        body: [
          "Having run a competition to find \u2018Britain\u2019s Best Garden\u2019, this branded content campaign for Yorkshire Tea culminated in this film showcasing the winning garden.",
          "Commissioned through the Telegraph Media Group, Matt directed and James edited this branded content piece that needed to do justice to both the garden and the brand behind it.",
          "On the recce, the undulations of the garden were immediately apparent, a jib was the obvious choice to capture the full scale and character of it, sweeping across the space in a way a static camera simply couldn't. Alongside the main camera setup, it gave the film the visual range the location deserved.",
          "The weather, as is traditional for an outdoor shoot in Britain, had its own ideas. Rain on a garden shoot could easily be a problem. Here it became an asset, adding atmosphere and texture to footage that might otherwise have felt too neat. You plan for all conditions and you adapt to what you get - and sometimes what you get is better than what you planned for!",
          "The film went on to contribute to a campaign that won Best Branded Content Campaign at the Campaign awards, recognition of a great work all round.",
        ],
        faqs: [
          { q: "How do you handle outdoor shoots in unpredictable weather?", a: "You plan for all conditions and you adapt to what you get. Unpredictable weather is a reality of outdoor location filming in the UK, and the answer is preparation - having contingency plans, flexible scheduling (if budget allows), and a crew experienced enough to make the most of whatever the day delivers. On the Yorkshire Tea shoot, the rain added atmosphere that improved the footage. It doesn't always work out that way, but experience helps you recognise the opportunity when it does." },
          { q: "Do you work with media groups and publishers on branded content commissions?", a: "Yes, we have experience producing branded content commissioned through media groups and publishers, where the editorial standards are high and the content needs to hold its own alongside the publisher's own output. It's a different context to a brand commissioning directly but we are well versed in both." },
          { q: "Have you produced award-winning content?", a: "Yes. The Yorkshire Tea branded content campaign, which this film was part of, won Best Branded Content Campaign at the Campaign awards. We're proud of the work, and the recognition reflects what good branded content can achieve when the brief, the creative, and the execution come together properly." },
        ] },
      { id: "dove-emotive-storytelling", href: "/work/dove-emotive-storytelling", client: "Dove", sector: "Consumer", title: "Emotive brand story", cat: ["Branded", "Sport"], ar: "16 / 9", video: "https://stream.mux.com/CKgesVaeT7IwZM01ZKSCCUhLZZVyBkl8O25MgMBEhZ1w/highest.mp4", vimeo: "312001005", vimeoAr: "16 / 9", uploadDate: "2019-01-17T18:18:41Z", duration: "PT2M41S",
        ...
        faqs: [
          { q: "Can a compelling brand film work without shooting any new footage?", a: "Yes, and it's a genuinely different discipline. Archive-led filmmaking is about constructing the narrative arc first, then sourcing and structuring existing footage to support that story, rather than starting from a shot list, which requires strong storytelling instincts more than production logistics." },
          { q: "How do you handle sensitive, real-life subject matter responsibly?", a: "Building trust with the contributor before shaping any narrative matters more than technique. Spending time understanding someone's actual experience, rather than treating them purely as a subject to extract soundbites from, tends to produce a film that reflects their real perspective rather than an outsider's interpretation of it." },
          { q: "What makes archive-heavy productions different to plan for?", a: "Sourcing and clearing usable archive footage for a specific historical event often takes considerably longer than a standard shoot day would, since it involves research and rights clearance rather than simply capturing what's needed on location." },
        ] },
      { id: "nfu-sponsored-content", href: "/work/nfu-sponsored-content", client: "NFU Mutual", sector: "Finance", title: "Sponsored content", cat: ["Branded"], ar: "16 / 9", video: "https://stream.mux.com/wffdb4jMCb1pLsBPz2Q8fWtRN00fOen1mPNfNNlxAb9o/highest.mp4", vimeo: "445542784", vimeoAr: "16 / 9", uploadDate: "2020-08-07T09:00:44Z", duration: "PT2M11S",
        ...
        faqs: [
          { q: "How do you make a financial brand feel authentic through unrelated subject matter?", a: "Rather than talking about the product directly, letting real people speak passionately about their own work builds a positive association with the sponsoring brand by proximity, rather than through a direct pitch, which tends to land better with audiences wary of obvious advertising." },
          { q: "Why does documentary-style content often outperform scripted testimonials?", a: "Genuine, unprompted enthusiasm reads as more credible than rehearsed lines, and audiences are generally good at telling the difference. Letting contributors speak in their own words, rather than a script, is usually what makes sponsored content feel trustworthy rather than transactional." },
          { q: "How do you plan a shoot across two distant locations in a short timeframe?", a: "Tight scheduling and thorough pre-production research into each location and contributor beforehand means shoot days can be spent capturing content rather than figuring out the story on arrival, which matters more the less travel buffer there is between locations." },
        ] },
      { id: "shell-corporate", href: "/work/shell-corporate", client: "Shell", sector: "Energy", title: "Corporate film", cat: ["Corporate"], ar: "16 / 9", video: "https://stream.mux.com/wErbQeg01rRjZImtMfiiNnKZYkhZBb02ttYtGuVxDhvDY/highest.mp4", vimeo: "429320412", vimeoAr: "16 / 9", uploadDate: "2020-06-15T12:17:13Z", duration: "PT2M35S",
        ...
        body: [
          "With Shell being a leading corporate player in their industry, they are constantly developing new fuel technologies. The film that we produced was to showcase one of their new consumer products, Shell V-Power Nitro+ diesel.",
          "Matt led a single shoot day at Shell's fuel technology lab in Hamburg, capturing the processes and environments that are involved to produce the product. The creative approach was a visual essay, so no talking heads and no formal interviews taking up screen time. Instead, a carefully crafted voiceover laid over cinematic footage that illustrates what's being explained as it's being said.",
          "The visual style was deliberately clinical and ordered featuring precise compositions, clean lines and a look that reflected the scientific environment. It's a format that works particularly well for technical subject matters with the visuals giving context to the voiceover.",
          "The voiceover itself came from an interview conducted with a Shell fuel scientist on location. The questions were designed specifically to yield material that could be shaped into a seamless narrative in the edit. Doing this requires careful preparation in pre-production, but the pay-off is that it produces a far more natural result than a scripted read. The interview was actually recorded in a car, which turned out to be the most practical solution on a tight one-day schedule!",
        ],
        faqs: [
          { q: "How do you make a highly technical subject engaging for a general audience?", a: "The key is to lead with the story rather than the science. Technical subject matter becomes engaging when it's framed around something the viewer can connect with such as a process they can follow, a problem being solved or a result they can understand. The visuals do the heavy lifting, the narration translates. Getting that balance right requires thorough research and planning in pre-production." },
          { q: "Where should the voiceover script come from on a technical project?", a: "In our experience, the best voiceovers on technical projects come from interviews with the people who know the subject best. We design the questions with the key messaging in mind, so the material we get back can be shaped into a seamless narrative in the edit. The result is a voiceover that carries genuine authority and lands the right messages, without sounding like it was written by a marketing team." },
          { q: "Is it worth travelling internationally to film on location rather than recreating a set elsewhere?", a: "It depends entirely on the brief. For Shell, filming in the actual laboratory in Hamburg was a non-negotiable, the whole purpose of the film rested on showing the real environment, the real equipment, and the real people behind the product. A recreated set would have undermined everything the film was trying to achieve." },
          { q: "Can you produce corporate films for large multinational organisations?", a: "Yes. Large organisations come with their own set of requirements such as multiple stakeholders, structured approval processes, brand guidelines, and a level of scrutiny that smaller commissions don't carry. We're very experienced working within those parameters and understand what is needed to have a film signed off at that level." },
        ] },
      { id: "subaru-branded-content", href: "/work/subaru-branded-content", client: "Subaru", sector: "Automotive", title: "Branded content", cat: ["Branded", "Automotive"], ar: "16 / 9", video: "https://stream.mux.com/vrkXtWubY92aQenx3eAoRjhC1UxeTNOfGa9SzBavMwM/highest.mp4", vimeo: "312002577", vimeoAr: "16 / 9", uploadDate: "2019-01-17T18:30:57Z", duration: "PT2M21S",
        ...
        faqs: [
          { q: "How do you find one location that works for multiple different vehicles?", a: "Thorough research before committing to travel, including desk research followed by physical recces, usually pays off, particularly when different vehicles need to demonstrate different strengths within a single, tight shooting schedule without time-consuming location changes." },
          { q: "What's the value of a recognisable presenter for automotive content?", a: "A host with genuine credibility in the space, rather than a generic presenter, brings built-in trust for driving-focused content, since audiences already associate them with real skill rather than someone reading lines about performance." },
          { q: "How does weather risk get managed on multi-day outdoor shoots?", a: "Building schedule flexibility in advance is essential, since outdoor conditions can shut down a shooting day entirely with little warning. Planning contingencies before the shoot starts, rather than reacting on the day, is usually what protects the key shots a client actually needs." },
        ] },
      { id: "cavalor", href: "/work/cavalor", client: "Cavalor", sector: "Equine", title: "Promotional video", cat: ["Corporate", "Sport"], ar: "16 / 9", video: "https://stream.mux.com/IbVQ6a9K9d2bZ5V4eId6lmJgXgJf9YdX3bMV2qgJllY/highest.mp4", vimeo: "988536100", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:25:25Z", duration: "PT4M24S",
        ...
        faqs: [
          { q: "How do you deliver a multi-location international shoot on a limited budget?", a: "Keeping the crew small is often the most effective lever, fewer people means more flexibility to move fast between locations without the logistics overhead a larger team brings, even if it means everyone on set takes on a broader role." },
          { q: "Why prioritise storytelling over direct brand messaging in promotional content?", a: "Some brands specifically want the emotional connection to a subject or community to do the work, rather than stating the pitch outright. Building a film entirely around contributors' personal stories, and trusting that goodwill reflects on the brand by association, is a deliberate creative choice, not a missed opportunity to sell." },
          { q: "How do you plan shoot days across international locations efficiently?", a: "International logistics leave far less room to improvise than a single-location domestic shoot, so planning each day down to the minute in advance, rather than adjusting on the fly, protects both the crew's wellbeing and the overall shoot timeline." },
        ] },
      { id: "aesme-instructional-video", href: "/work/aesme-instructional-video", client: "Aesme", sector: "Consumer", title: "Instructional video", cat: ["Branded"], ar: "1 / 1", video: "https://stream.mux.com/CFr8mlhQQYKOOkAm02sxCMz5AG01783yovYR502dD5pnpg/highest.mp4", vimeo: "988531951", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:14:13Z", duration: "PT1M22S",
        ...
        faqs: [
          { q: "How do you solve sound problems on a location you can't change?", a: "When a location has an unavoidable environmental issue, careful mic placement and timing takes around the problem, in this case train noise, solve it during production rather than relying on being able to fix it afterwards in the edit." },
          { q: "How do you rebuild trust with a client who's had a bad experience with a previous production company?", a: "Following their existing plan and storyboards precisely, rather than pushing an alternative creative direction, is usually the right call early in the relationship. Trust gets earned through reliability first, creative latitude tends to come later once a client's confidence is established." },
          { q: "How do you make instructional content accessible to a broad audience?", a: "Prioritising clarity over stylistic flourish, straightforward camera setups, clear lighting, and simple, well-paced demonstrations, usually serves an instructional brief better than an overly stylised approach that risks distracting from the actual information being communicated." },
        ] },
      { id: "telegraph-lullingstone-castle", href: "/work/telegraph-lullingstone-castle", client: "The Telegraph", sector: "Media", title: "Lullingstone Castle film", cat: ["Social"], ar: "16 / 9", video: "", vimeo: "1127525470", vimeoHash: "387659f32f", vimeoAr: "16 / 9", uploadDate: "2025-10-15T09:46:01Z", duration: "PT3M29S", vimeoNativeAr: 0.75, vimeoThumb: "https://i.vimeocdn.com/video/2070282340-9580c0c0479537a059f2680a925e6a0be9fc03b8a1d9fd0ed2b4a26dc028c2dd-d_960x540?region=us",
        ...
        faqs: [
          { q: "How do you approach a shoot with only one day and one interview subject?", a: "Pre-production research becomes disproportionately important when there's no opportunity to return for follow-up material. Going in with a strong understanding of the story and the questions that will draw it out properly matters far more than it would on a multi-day shoot with room for a second pass." },
          { q: "How do you structure a film around a genuinely dramatic true story?", a: "The instinct is often to over-dramatise with heavy editing or music, but letting a subject's own account carry the tension usually produces a stronger, more credible result. Restraint in the edit tends to serve powerful material better than amplification does." },
          { q: "What makes a story suit a publication's video arm rather than standard brand content?", a: "Genuine narrative depth and human interest, rather than polish or a marketing message, is usually the deciding factor. Content built more like a short documentary than a promotional piece tends to fit that editorial context far better." },
        ] },
      { id: "barclays-social-advice", href: "/work/barclays-social-advice", client: "Barclays", sector: "Finance", title: "Social advice content", cat: ["Corporate", "Social"], ar: "1 / 1", video: "", vimeo: "1208420545", vimeoHash: "7dd07a857c", vimeoAr: "16 / 9", uploadDate: "2026-07-09T09:03:37Z", duration: "PT2M11S", vimeoThumb: "https://i.vimeocdn.com/video/2177739816-f98c153c0568f48cca470d0b7c4565d1b86dc4da24acf76d38045846ffafe2f3-d_960x540?region=us",
        ...
        body: [
          "Rapp, part of the Omnicom group, regularly bring us in as their production partner on a series of financial advice films for their client, Barclays. These were produced for use across YouTube, social channels, websites, and embedded email campaigns.",
          "For the most recent series we shot in a London townhouse in Bermondsey, chosen for its character and the visual interest it brings to what could otherwise be a straightforward talking head setup. However, although what you see on screen looks clean and considered, what you don't see is the reality of getting heavy production equipment up six flights of stairs to make it happen! That's the unglamorous side of location filming in London, but it's often the case and is prepared for as part of our pre-production planning.",
          "We shot this with two cameras and we also supplied an autocue system and operator. This allows talent to deliver the lines directly to camera with confidence, which is particularly useful for content where messaging needs to be precise such as with financial advice, legal communications or anything else where the exact wording matters.",
          "Getting a consistent, polished look across a full day of filming with natural light changing throughout, requires careful planning and the right equipment. The lighting setup, despite appearing subtle on screen, was extensive. This is the film before handoff, Rapp applied motion graphics in post.",
        ],
        faqs: [
          { q: "Do you work directly with creative agencies?", a: "Yes, we regularly work as a production partner for creative and communications agencies who need a reliable production team. We integrate into your process, whether that means working to an approved creative treatment or taking a more hands-on role in shaping the production." },
          { q: "Can you supply an autocue?", a: "Yes, when required we supply and operate an autocue system, allowing talent to deliver directly to camera with confidence. Whether someone is an experienced presenter or has never been in front of a camera before, autocue removes the need to memorise lines, meaning the person in the hot seat can focus on the delivery rather than remembering the words." },
          { q: "Can you shoot multiple pieces of content in a single day?", a: "Yes, and it's often the most efficient way to work. A well-planned single shoot day can yield a significant volume of finished content such as a hero film, social cutdowns and format variations. The planning upfront is what makes it possible. That said, there's a limit to what a single day can realistically deliver - trying to squeeze too much in is one of the most common mistakes clients make, and ultimately it's the content that ends up compromised." },
          { q: "What's involved in producing social video content for financial services brands?", a: "Financial services content carries specific responsibilities around tone, accuracy, and compliance. We work within those parameters from the briefing stage, and we're experienced in producing content that meets the standards these brands require without losing its watchability in the process." },
        ] },
      { id: "uniteq-brand-launch", href: "/work/uniteq-brand-launch", client: "Uniteq", sector: "Fashion", title: "Brand launch", cat: ["Social"], ar: "3 / 4", video: "", vimeo: "1208380461", vimeoHash: "ee5536a47e", vimeoAr: "9 / 16", uploadDate: "2026-07-09T06:45:43Z", duration: "PT35S", vimeoThumb: "https://i.vimeocdn.com/video/2177691023-a113fb55e1dc3372d83a70b39a962333066bc10de00da21c96d8932ccb49f767-d_960x540?region=us",
        ...
        body: [
          "Uniteq came to us with a brief to launch their new clothing brand on social media. Twelve social clips and a hero film, all shot in a single day on location in Surrey, in mid-December.",
          "The brief was clear from the outset, this wasn't a conventional fashion shoot. Uniteq wanted the brand to feel authentic and lived-in rather than polished and aspirational - clothing that looks like it belongs on real people doing real things, not on a studio set under perfect lighting. The creative direction followed from that, featuring handheld camera work, deliberate movement and the models directed to inhabit the clothes rather than model them.",
          "Mid-December in Surrey is not the most forgiving filming environment especially when most of the filming was being done in drafty stables (the models were very grateful for the heated tackroom as somewhere to relax between takes). Short days, cold temperatures, and flat winter light are the reality of outdoor location shooting at that time of year and all of it had to be managed within a single shoot day without compromising the creative.",
          "Every setup, every transition, every model direction had to be planned in advance to ensure the most efficient filming for the day.",
        ],
        faqs: [
          { q: "Can you produce video content for a brand launch on social media?", a: "Yes. A brand launch is one of the most important moments in a brand's life, and the content needs to work hard across multiple platforms simultaneously. We plan the shoot around the deliverables from the outset - a hero film, vertical clips, format variations, so all assets can come out of a single production." },
          { q: "Do you produce fashion and apparel video content?", a: "Yes, we have worked with a number of fashion brands. Fashion and apparel production requires a specific eye, the way clothing moves, the way it's lit, the way models are directed all contribute to how the brand reads on screen. Whether the brief calls for something polished and aspirational or raw and authentic, the approach starts with understanding what the brand is trying to say and building the creative around that." },
          { q: "Can you shoot a high volume of content in a single day?", a: "Yes, when the brief lends itself to it. Twelve social clips and a hero film in a single day is achievable with the right planning with every setup mapped out in advance, the schedule built around the creative rather than the other way around. The spontaneity on camera only works when everything around it is tightly organised." },
          { q: "Do you produce vertical video and content for social platforms?", a: "Yes. We produce content in whatever format the brief requires whether thats vertical, landscape, square, or any combination. For Uniteq, the brief called for vertical, so that's what we delivered. The creative principles are the same regardless of format, what changes is the framing and the technical specifications at the delivery stage." },
        ] },
];
...
export const workFaqItems: Faq[] = [
      { q: "How do you choose which projects to feature here?", a: "This page shows a representative spread rather than a complete archive of everything we've made. Client confidentiality plays a real part in that: some of our most significant, longest-running relationships sit under NDA and can't be shown publicly at all, which means what you're seeing here skews toward projects where the client was happy for the work to be used as a public case study. We try to keep a genuine mix across sectors and formats rather than over-representing whichever type of project happened to be shot most recently, so this page reflects breadth of capability as much as individual highlights." },
      { q: "Can we see more examples in a specific sector before briefing you?", a: "Yes, and this is genuinely one of the more useful conversations to have before a brief goes out. Get in touch and we can share further examples relevant to your industry, including work that isn't listed publicly here for confidentiality reasons. Seeing sector-specific reference points tends to give a much clearer sense of how we'd actually approach your project than browsing the general portfolio alone, particularly if your industry has specific compliance, tone or stakeholder considerations that a generic showreel won't demonstrate." },
      { q: "Do you shoot everything in-house, or bring in freelance crew?", a: "A mix of both, and the balance shifts depending on what a project actually needs. Our core team handles direction, production management and post-production on every job, giving continuity and accountability throughout. Alongside that, we bring in trusted freelance specialists, camera operators, colourists, sound engineers, when a project calls for a particular skill set, a larger crew than we'd carry permanently, or specific technical experience we want matched precisely to the brief. This approach lets us scale up for a six-week international documentary shoot just as easily as we handle a single-day local production, without carrying unnecessary overhead on smaller jobs." },
      { q: "Who owns the footage and final files once a project's delivered?", a: "Ownership and usage rights vary depending on the agreement in place for each individual project, since different clients and industries have different needs here, some want full unrestricted ownership of raw footage, others are primarily concerned with rights to the final edited deliverable across specific platforms. We're happy to discuss and agree this upfront before any filming begins, rather than leaving it as an assumption on either side, since getting it wrong after delivery tends to create far more friction than addressing it properly at the brief stage." },
      { q: "Can we speak to past clients before briefing you?", a: "Yes, we're happy to put you in touch with clients relevant to your sector or the type of project you're planning. Hearing directly from someone who's been through the process with us, particularly around how we handled logistics, communication and any unexpected challenges on the day, often gives a more honest picture than a portfolio piece alone can. We'd rather a prospective client felt genuinely confident going into a brief than oversell our own capabilities and risk a mismatch in expectations later." },
      { q: "Do you work directly with brands, or only through agencies?", a: "Both, and the two relationships work quite differently in practice. Some of our work comes through creative or marketing agencies who bring us in specifically for production, handling the creative concept and client relationship themselves while we focus on directing, filming and editing to their specification, our ongoing work with Rapp on Barclays' content is a good example of that model. Other clients brief us directly, in which case we're often more involved in shaping the creative approach from the outset rather than just executing someone else's vision. Neither arrangement is a lesser way of working with us, they simply call for a different level of creative involvement on our side." },
];
