...
export const workAll: Project[] = [
      ...
      { id: "shell-corporate", href: "/work/shell-corporate", client: "Shell", sector: "Energy", title: "Corporate film", cat: ["Corporate"], ar: "16 / 9", video: "https://stream.mux.com/wErbQeg01rRjZImtMfiiNnKZYkhZBb02ttYtGuVxDhvDY/highest.mp4", vimeo: "429320412", vimeoAr: "16 / 9", uploadDate: "2020-06-15T12:17:13Z", duration: "PT2M35S",
        ...
        faqs: [
          { q: "How do you make a highly technical subject engaging for a general audience?", a: "A visual essay approach, cinematic imagery paired with a curated voiceover, often works better than talking-heads formats for technical subjects, since removing the expert from screen keeps focus on visuals doing the explanatory work rather than someone explaining to camera." },
          { q: "Where should the voiceover script come from on a technical project?", a: "Building the script from a genuine interview with a subject expert, rather than writing independently, keeps the technical accuracy grounded in real expertise while still giving the editorial team room to shape it into something accessible for a general viewer." },
          { q: "Is it worth travelling internationally to film on location rather than recreating a set elsewhere?", a: "Usually, yes, when the location itself carries credibility. Filming inside an actual facility, like Shell's fuel technology lab, gives a corporate film a sense of authenticity that a generic studio recreation or stock footage simply can't replicate." },
        ] },
