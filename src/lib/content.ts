...
export const workAll: Project[] = [
      { id: "boss-brand-promo", href: "/work/boss-brand-promo", client: "BOSS", sector: "Fashion", title: "Brand promo", cat: ["Branded", "Social"], ar: "3 / 4", video: "https://stream.mux.com/302UbMIkwPH502t3w6LTTS6XOzH02024rutfQioEwNxaBCU/highest.mp4", vimeo: "988531174", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:12:11Z", duration: "PT1M30S",
        ...
        faqs: [
          { q: "Do you handle creative development, or just execute someone else's brief?", a: "Both, depending on what the client needs. On this project BOSS gave us a detailed brief but relied on us to develop the actual shooting style, particularly for the teaser, which needed a completely different tone to the main feature. We regularly move between full creative ownership and tight execution of someone else's vision within the same project." },
          { q: "What's involved in filming with a high-profile sports ambassador?", a: "Working with an athlete like Harry Charles means building the schedule around their availability and energy levels rather than a standard studio day, and structuring interviews so the personal story comes through naturally rather than sounding rehearsed. Having his father, an Olympic gold medallist, in the same conversation added a generational layer we had to balance carefully in the edit." },
          { q: "Why shoot a teaser and a main film as separate pieces?", a: "Different objectives need different pacing. The teaser's job was purely to create intrigue ahead of the launch, deliberately withholding information, while the main film had to deliver the actual narrative and payoff. Treating them as two distinct creative briefs, rather than one film cut two ways, is usually what makes a teaser strategy actually work." },
        ] },
      ...
      { id: "peugeot-multi-camera", href: "/work/peugeot-multi-camera", client: "Peugeot", sector: "Automotive", title: "Multi-camera tennis challenge", cat: ["Branded", "Sport"], ar: "16 / 9", video: "https://stream.mux.com/Cbn4PS6Km4ejUNw6o02y01WHUDMEstYiV00g00tuIAPL3B00/highest.mp4", vimeo: "1003234232", vimeoHash: "bf316591c9", vimeoAr: "16 / 9", uploadDate: "2024-08-27T10:58:48Z", duration: "PT2M30S",
        ...
        faqs: [
          { q: "How do you prepare for filming a live event you can't control?", a: "Unlike a scripted shoot where we can reset and reshoot, a live event gives you one pass. That means camera positions, lens choices and shot lists all have to be locked in pre-production, and the crew needs a shared understanding of who's covering what so nothing gets missed in real time." },
          { q: "What's the benefit of multi-camera coverage for this kind of content?", a: "It lets you capture spontaneous reactions and genuine moments, like Anton du Beke's crowd interaction, from multiple angles without needing to ask anyone to repeat themselves. For sponsorship and event content particularly, that authenticity is usually the whole point of being there." },
          { q: "Why would a brand sponsor content like this rather than a straightforward product film?", a: "Association with a live, entertaining event does something a studio ad can't - it puts the brand inside a genuine cultural moment people already want to watch. Peugeot's tennis sponsorship worked because the content felt like coverage of a fun event first, and branded content second." },
        ] },
      ...
      { id: "bmw-creative-car-review", href: "/work/bmw-creative-car-review", client: "BMW", sector: "Automotive", title: "Creative car reviews", cat: ["Branded", "Automotive"], ar: "16 / 9", video: "https://stream.mux.com/Fw028ShcEJsNWI7EyzPHlan6Meryw401ZaTLYl0100RyNME/highest.mp4", vimeo: "312000081", vimeoAr: "16 / 9", uploadDate: "2019-01-17T18:11:58Z", duration: "PT2M18S",
        ...
        faqs: [
          { q: "Why use a presenter rather than a voiceover-only format?", a: "A host like Jodie Kidd gives the review a point of view and personality that pure specs-and-voiceover can't. For a premium brand like BMW, that human element signals the car is aspirational and lifestyle-driven, not just a technical product." },
          { q: "How do you plan a shoot across multiple locations and lighting conditions?", a: "Night shoots in central London and daytime studio work require completely different lighting setups, crew calls, and even different lens choices to handle the contrast between neon-lit streets and a controlled infinity white backdrop. Scheduling has to account for London traffic and access permits too, which rarely cooperate at 2am." },
          { q: "What made this different from a standard manufacturer car review?", a: "Most car reviews are template-driven - walk around, spec rundown, driving shots. We deliberately pushed for a higher production value, cinematic lighting, a recognisable host, and genuine locations, to make the content feel like it belonged in a media outlet like Telegraph Media Group rather than a manufacturer's own channel." },
        ] },
      { id: "aston-martin", href: "/work/aston-martin", client: "Aston Martin", sector: "Automotive", title: "V12 Vantage launch", cat: ["Automotive"], ar: "3 / 4", video: "https://stream.mux.com/35R023901blr00LZ01OxgY00emQunUd12MgaeUDOCfKkoBdE/highest.mp4", vimeo: "988536270", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:25:52Z", duration: "PT5M8S",
        ...
        faqs: [
          { q: "How do you choose camera and lens packages on a tight budget?", a: "We balance the visual result the client needs against what's actually affordable. For this launch we used Canon's CN7 to get contra-zoom capability within budget, and switched to Arri Ultra Prime lenses for shots where cinematic image quality mattered more than the zoom function." },
          { q: "What's a contra-zoom and why use it for a car launch?", a: "It's a technique where the camera physically moves toward the subject while the lens zooms out, creating a disorienting, dramatic effect. For a launch film it draws attention to the car as the hero of the frame, a technique borrowed from film rather than typical automotive advertising." },
          { q: "How much creative input do you get on agency-led productions?", a: "It varies by project, but on this one, once the Creative Agency set the brief, they specifically asked us to suggest ways to make the film stand out. We proposed using lens prisms to create abstract foreground reflections, which ended up in the final cut." },
        ] },
      ...
      { id: "nested", href: "/work/nested", client: "Nested", sector: "Property", title: "Social media campaign", cat: ["Corporate"], ar: "3 / 4", video: "https://stream.mux.com/YxwZU01pBBOcZkT4qzsXoDiK7jJGwmmIpoUyvN7DdhWs/highest.mp4", vimeo: "988532031", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:14:28Z", duration: "PT50S",
        ...
        faqs: [
          { q: "How do you keep a large-scale shoot efficient across multiple locations?", a: "Keeping the kit minimal was deliberate - handheld b-roll on prime lenses meant the crew could move fast between six boroughs without heavy lighting setups slowing things down. Lighting was reserved only for the pieces to camera, which kept the whole six-day shoot moving at pace." },
          { q: "Why have agents talk directly to camera rather than using a narrator?", a: "Direct address builds trust faster for a service brand like an estate agency, since the viewer is essentially being spoken to by the person they might actually deal with. Filming each agent in their own homely setting reinforced that same sense of familiarity." },
          { q: "How closely do you work with a client's in-house marketing team?", a: "Very closely on projects like this. We developed the on-camera approach directly with Nested's marketing team rather than presenting a finished concept, which meant the tone stayed authentic to how their agents actually communicate rather than how a production company assumed they should sound." },
        ] },
      ...
      { id: "mahou-beer-promos", href: "/work/mahou-beer-promos", client: "Mahou", sector: "Drinks", title: "Beer promos", cat: ["Branded"], ar: "16 / 9", video: "https://stream.mux.com/qlCs1JxItVxZ8Q9QB6sLp6a6auDOnvzY02fFV1hYWg8w/highest.mp4", vimeo: "325920534", vimeoHash: "c7917b056b", vimeoAr: "16 / 9", uploadDate: "2019-03-22T13:30:25Z", duration: "PT2M27S",
        ...
        faqs: [
          { q: "How do you approach branded content for a market a brand hasn't launched in yet?", a: "The films had to do double duty - introduce Mahou as a product while also communicating a cultural association with Madrid tapas culture that UK audiences wouldn't already have. That meant weighting the storytelling toward food and social atmosphere as much as the product itself." },
          { q: "What's the challenge of a 2-minute branded content format?", a: "Packing both food content and brand messaging into two minutes forces hard editorial choices about what earns screen time. We treated each film as a mini story with a beginning and end, rather than trying to cram in every message the client wanted." },
          { q: "How do you collaborate with a client's existing commercial video team?", a: "On this project we worked directly with the Telegraph Commercial Video team to conceptualise the campaign jointly, rather than being handed a finished brief. That collaborative approach across four locations and four shoot days meant the tone stayed consistent even as the settings changed." },
        ] },
      ...
      { id: "dove-emotive-storytelling", href: "/work/dove-emotive-storytelling", client: "Dove", sector: "Consumer", title: "Emotive brand story", cat: ["Branded", "Sport"], ar: "16 / 9", video: "https://stream.mux.com/CKgesVaeT7IwZM01ZKSCCUhLZZVyBkl8O25MgMBEhZ1w/highest.mp4", vimeo: "312001005", vimeoAr: "16 / 9", uploadDate: "2019-01-17T18:18:41Z", duration: "PT2M41S",
        ...
        faqs: [
          { q: "Can you produce a compelling film without shooting new footage?", a: "Yes, this project was built almost entirely from archive material and a single new interview. The craft is in constructing the narrative arc first, then sourcing and structuring existing footage to support that story, which is a genuinely different skill set from a standard shoot-and-edit project." },
          { q: "How do you handle emotionally sensitive real-life subject matter?", a: "Building trust with the contributor matters more than technique here. We spent time with Scott Fardy understanding his experience of the 2011 Japan tsunami before shaping any of the narrative, so the final film reflected his actual perspective rather than an outside interpretation of it." },
          { q: "What's involved in an archive-heavy production timeline?", a: "Sourcing rights-cleared archive footage of a specific historical event took considerably longer than filming would have, since it involves tracking down usable material and clearing it for use rather than simply capturing what's needed on a shoot day." },
        ] },
      { id: "nfu-sponsored-content", href: "/work/nfu-sponsored-content", client: "NFU Mutual", sector: "Finance", title: "Sponsored content", cat: ["Branded"], ar: "16 / 9", video: "https://stream.mux.com/wffdb4jMCb1pLsBPz2Q8fWtRN00fOen1mPNfNNlxAb9o/highest.mp4", vimeo: "445542784", vimeoAr: "16 / 9", uploadDate: "2020-08-07T09:00:44Z", duration: "PT2M11S",
        ...
        faqs: [
          { q: "How do you make a financial services brand feel authentic through unrelated subject matter?", a: "Rather than talking about insurance directly, we let the producers - a gin distiller and a dairy farmer - speak passionately about their own work, which reflects well on the brand sponsoring the content by association rather than direct pitching." },
          { q: "What makes documentary-style sponsored content effective?", a: "People engage with genuine enthusiasm far more than scripted testimonials. Both producers featured spoke about their businesses unprompted and in their own words, which is why documentary portraiture tends to outperform more traditional advertising formats for trust-building content." },
          { q: "How do you plan a two-location shoot in different parts of the country?", a: "Logistics and travel time between the Wye Valley and Lincolnshire meant tight scheduling across the two days, with pre-production research into both producers' businesses done in advance so filming time on location was spent capturing content, not figuring out the story on the day." },
        ] },
      { id: "shell-corporate", href: "/work/shell-corporate", client: "Shell", sector: "Energy", title: "Corporate film", cat: ["Corporate"], ar: "16 / 9", video: "https://stream.mux.com/wErbQeg01rRjZImtMfiiNnKZYkhZBb02ttYtGuVxDhvDY/highest.mp4", vimeo: "429320412", vimeoAr: "16 / 9", uploadDate: "2020-06-15T12:17:13Z", duration: "PT2M35S",
        ...
        faqs: [
          { q: "How do you make a technical, niche subject engaging for a general audience?", a: "We used a visual essay approach - cinematic shots paired with a curated voiceover - rather than talking heads explaining the science directly. Removing the interview subject from screen kept focus on the visuals doing the explanatory work, which suits complex subjects better than a straight-to-camera format." },
          { q: "Where does the voiceover script come from on a project like this?", a: "We interviewed a Shell fuel scientist on location and built the narrative voiceover from that conversation, rather than writing a script independently. That meant the technical accuracy came directly from an expert, while we shaped it into something accessible for a general viewer." },
          { q: "What's the value of travelling internationally for a corporate film?", a: "Filming at Shell's actual fuel technology lab in Hamburg, rather than recreating it elsewhere, gave the film genuine credibility and access that stock footage or a generic lab set couldn't replicate." },
        ] },
      { id: "subaru-branded-content", href: "/work/subaru-branded-content", client: "Subaru", sector: "Automotive", title: "Branded content", cat: ["Branded", "Automotive"], ar: "16 / 9", video: "https://stream.mux.com/vrkXtWubY92aQenx3eAoRjhC1UxeTNOfGa9SzBavMwM/highest.mp4", vimeo: "312002577", vimeoAr: "16 / 9", uploadDate: "2019-01-17T18:30:57Z", duration: "PT2M21S",
        ...
        faqs: [
          { q: "How do you find locations that work for multiple vehicles in one shoot?", a: "We researched extensively on Google Maps before two days of physical recces, since the Forester and Levorg needed to showcase completely different strengths - off-road capability versus on-road handling - within a tight three-day schedule and without time-consuming location moves." },
          { q: "What's the value of using a well-known presenter like a former Top Gear Stig?", a: "A recognisable face like Ben Collins brings built-in credibility for a driving-focused review, since audiences already associate him with genuine driving skill rather than a generic presenter reading lines about performance." },
          { q: "How does weather affect a multi-day outdoor automotive shoot?", a: "Significantly. Filming in Snowdonia in November meant planning contingencies for conditions that could shut down a day's shooting entirely, and building enough schedule flexibility to still hit both vehicles' key shots despite the weather working against us." },
        ] },
      { id: "cavalor", href: "/work/cavalor", client: "Cavalor", sector: "Equine", title: "Promotional video", cat: ["Corporate", "Sport"], ar: "16 / 9", video: "https://stream.mux.com/IbVQ6a9K9d2bZ5V4eId6lmJgXgJf9YdX3bMV2qgJllY/highest.mp4", vimeo: "988536100", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:25:25Z", duration: "PT4M24S",
        ...
        faqs: [
          { q: "How do you deliver a multi-location shoot on a limited budget?", a: "Keeping the crew to just three people - a director and two camera operators - was a deliberate budget decision that also gave us more flexibility to move fast across three locations in two countries without the logistics overhead of a larger team." },
          { q: "Why prioritise storytelling over direct brand messaging in a promotional video?", a: "Cavalor specifically wanted the film to be about the beauty of the equestrian world rather than a product pitch, so we built the structure entirely around contributors' personal stories, trusting that emotional connection would reflect well on the brand without stating it directly." },
          { q: "How do you plan shoot days across international locations?", a: "Every minute was planned in advance to avoid overworking the crew while still capturing five contributors across three locations, since international logistics leave far less room for improvising on the day than a single-location UK shoot would." },
        ] },
      { id: "aesme-instructional-video", href: "/work/aesme-instructional-video", client: "Aesme", sector: "Consumer", title: "Instructional video", cat: ["Branded"], ar: "1 / 1", video: "https://stream.mux.com/CFr8mlhQQYKOOkAm02sxCMz5AG01783yovYR502dD5pnpg/highest.mp4", vimeo: "988531951", vimeoAr: "16 / 9", uploadDate: "2024-07-22T14:14:13Z", duration: "PT1M22S",
        ...
        faqs: [
          { q: "How do you solve sound problems on a fixed, non-negotiable location?", a: "The floristry studio was directly beneath a railway line, so location wasn't something we could change. Our sound recordist managed the problem through careful mic placement and take timing around train schedules, solving it in production rather than trying to fix it in post." },
          { q: "What's different about working with a client who's had a bad experience with a previous production company?", a: "Aesme came to us with detailed storyboards already prepared, having been let down before, so trust had to be earned by following their existing plan precisely rather than pushing our own creative direction onto a client who'd already been burned once." },
          { q: "How do you make instructional content accessible to a wide audience?", a: "Aesme's priority was clarity over style, so we kept the visual approach straightforward - two cameras capturing clear, well-lit demonstrations - rather than adding stylistic flourishes that could distract from the instructional purpose of the content." },
        ] },
      { id: "telegraph-lullingstone-castle", href: "/work/telegraph-lullingstone-castle", client: "The Telegraph", sector: "Media", title: "Lullingstone Castle film", cat: ["Social"], ar: "16 / 9", video: "", vimeo: "1127525470", vimeoHash: "387659f32f", vimeoAr: "16 / 9", uploadDate: "2025-10-15T09:46:01Z", duration: "PT3M29S", vimeoNativeAr: 0.75, vimeoThumb: "https://i.vimeocdn.com/video/2070282340-9580c0c0479537a059f2680a925e6a0be9fc03b8a1d9fd0ed2b4a26dc028c2dd-d_960x540?region=us",
        ...
        faqs: [
          { q: "How do you approach a single-day shoot built around one interview subject?", a: "With only a day at Lullingstone Castle, pre-production research into Tom Hart Dyke's story mattered more than usual, since there was no opportunity to return for follow-up material if something didn't land in the interview itself." },
          { q: "How do you structure a film around a story this dramatic?", a: "The challenge is pacing - letting a story involving a kidnapping, nine months in captivity, and a garden literally sketched while facing execution unfold naturally rather than over-dramatising it. We let Tom's own account carry the tension rather than adding heavy-handed music or editing tricks." },
          { q: "What made this a good fit for The Telegraph specifically?", a: "It's the kind of long-form human interest story that suits a publication's video arm rather than typical brand content - genuine narrative depth over polish - which is why we approached the edit more like a short documentary than a promotional piece." },
        ] },
