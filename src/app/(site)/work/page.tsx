    ...
    <main>
      ...
      <section className="bg-[var(--brand)] text-white pt-[clamp(64px,8vw,112px)] pb-[clamp(32px,4vw,48px)]">
        <div className="max-w-[1280px] mx-auto px-[clamp(20px,5vw,48px)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[auto_minmax(0,1fr)] gap-[clamp(32px,4vw,64px)] items-start">
            <div>
                ...
                {filterNames.map((f) => {
                  ...
                  return (
                    <button
                      key={f}
                      onClick={() => setFilter(f)}
                      className="whitespace-nowrap px-[14px] py-[8px] font-mono font-medium text-[11px] tracking-[0.1em] uppercase cursor-pointer transition-colors"
                      style={
                        active
            ...
            <p className="min-w-0 text-[clamp(14px,1.3vw,15px)] leading-[1.6] text-white/85">
              ...
              film for organisations who need something more considered than a standard company video. Filter by
              type below, or get in touch if you want to see something specific to your sector.
            </p>
          </div>
        </div>
      </section>
